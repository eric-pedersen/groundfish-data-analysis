...
plot(Year_Geom_Means$GADUS_MORHUA[1:14]~c(1981:1994),type='l',lwd=2, ylab="Biomass (kg/tow)", xlab=NA,col=top4_palette[1],cex.lab=label.V,cex.axis=axis.V,xaxt='n',ylim=c(0,33),xlim=c(1981,2013))
lines(Year_Geom_Means$GADUS_MORHUA[15:33]~c(1995:2013),type='l',lwd=2,col=top4_palette[1])
plotCI(c(1981:2013),Year_Geom_Means$GADUS_MORHUA,uiw=Year_Geom_Means_SE$GADUS_MORHUA,add=T, pch=NA,sfrac=0, col=top4_palette[1])
axis(1,seq(1980,2010,by=5),cex=1.4,labels=F,tick=T)
lines(Year_Geom_Means$REINHARDTIUS_HIPPOGLOSSOIDES[1:14]~c(1981:1994),col=top4_palette[2],lwd=2)
lines(Year_Geom_Means$REINHARDTIUS_HIPPOGLOSSOIDES[15:33]~c(1995:2013),col=top4_palette[2],lwd=2)
plotCI(c(1981:2013),Year_Geom_Means$REINHARDTIUS_HIPPOGLOSSOIDES,uiw=Year_Geom_Means_SE$REINHARDTIUS_HIPPOGLOSSOIDES,add=T, pch=NA,sfrac=0, col=top4_palette[2])
lines(Year_Geom_Means$HIPPOGLOSSOIDES_PLATESSOIDES[1:14]~c(1981:1994),col=top4_palette[3],lwd=2)
lines(Year_Geom_Means$HIPPOGLOSSOIDES_PLATESSOIDES[15:33]~c(1995:2013),col=top4_palette[3],lwd=2)
plotCI(c(1981:2013),Year_Geom_Means$HIPPOGLOSSOIDES_PLATESSOIDES,uiw=Year_Geom_Means_SE$HIPPOGLOSSOIDES_PLATESSOIDES,add=T, pch=NA,sfrac=0, col=top4_palette[3])
lines(Year_Geom_Means$SEBASTES_MENTELLA[1:14]~c(1981:1994),col=top4_palette[4],lwd=2)
